...
# Create a Dash app for the forecasting page
dash.register_page(__name__, path='/ml_graph', layout=html.Div([
    html.Div(
            html.H1("Dashboard > ML-Model", className="h5 mb-0 text-gray-800"),
