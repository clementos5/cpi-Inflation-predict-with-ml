            ...
            [
                dbc.Row(
                    [
                        dbc.Container(
                            [
                                html.H1(" Inflation forecasting model Demonstration", className="display-4"),
                                html.P("The dashboard is build in Dash/Python "
                                    "Explore the various features to gain insights form CPI DATA Collected from 2009 until today", className="lead"),
                                ...
                                html.Ul([
                                    ...
                                    # Add more features as needed
                                    html.Li(["Inflation modeling",
                                            html.Ul([
                                                html.Li("facts to choose the model"),
                                                html.Li("Benchmarck Models"),
                                                html.Li("ML Models"),
                                ...
                                html.P("on Left panel(sidebar) navigation to explore different sections of the dashboard.",
